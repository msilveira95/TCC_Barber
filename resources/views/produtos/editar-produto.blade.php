...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3 col-sm-8 offset-sm-2 col-12 offset-0 margin-top-30px">
            @foreach($produto as $infoprod)
            @endforeach
            
            <form action="/produto/editar-produto/{{$infoprod->id}}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pDesc" placeholder="Descrição" class="form-control {{ $errors->has('pDesc') ? 'is-invalid' : '' }}" value="{{$infoprod->descricao}}">
                    @if($errors->has('pDesc'))
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pValor" placeholder="R$" class="form-control {{ $errors->has('pValor') ? 'is-invalid' : '' }}"  value="{{$infoprod->valor}}">
